...
export const initialNodes: Node[] = [
  ...
  { id: 'gosia', data: { label: 'Małgorzata (Gosia)', branch: 'main', role: 'Żona' }, position: { x: 0, y: 0 } },
  { id: 'pawel', data: { label: 'Paweł (Ty)', branch: 'main', role: 'Mąż' }, position: { x: 0, y: 0 } },
  { id: 'tosia', data: { label: 'Antonina (Tosia)', branch: 'main', role: 'Córka' }, position: { x: 0, y: 0 } },
  { id: 'janek', data: { label: 'Janek', branch: 'main', role: 'Syn' }, position: { x: 0, y: 0 } },
  { id: 'marcin', data: { label: 'Marcin', branch: 'siudzinski', role: 'Brat Gosi' }, position: { x: 0, y: 0 } },
  { id: 'marzena_m', data: { label: 'Marzena', branch: 'other', role: 'Żona Marcina' }, position: { x: 0, y: 0 } },
  { id: 'ciri', data: { label: 'Ciri', branch: 'siudzinski', role: 'Córka Marcina i Marzeny' }, position: { x: 0, y: 0 } },
  { id: 'kayla', data: { label: 'Kayla', branch: 'siudzinski', role: 'Córka Marcina i Marzeny' }, position: { x: 0, y: 0 } },
...
export const initialEdges: Edge[] = [
  ...
  { id: 'e_mm_c', source: 'marzena_m', target: 'ciri', type: 'step' },
  { id: 'e_mm_k', source: 'marzena_m', target: 'kayla', type: 'step' },
