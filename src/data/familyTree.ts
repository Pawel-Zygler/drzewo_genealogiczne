...
export const initialEdges: Edge[] = [
  // Dominik & Siudzińscy
  { id: 'e_ad_as', source: 'anna_d', target: 'aleksander_s', type: 'step', style: { strokeDasharray: '5,5' }, animated: true },
  { id: 'e_zd_ks', source: 'zofia_d', target: 'kazimierz_s', type: 'step', style: { strokeDasharray: '5,5' }, animated: true },
  { id: 'e_nnd_m1', source: 'nn_d', target: 'maz_1', type: 'step', style: { strokeDasharray: '5,5' } },
  { id: 'e_nnd_fw', source: 'nn_d', target: 'franciszek_w', type: 'step', style: { strokeDasharray: '5,5' } },
  { id: 'e_fw_ww', source: 'franciszek_w', target: 'wieslawa_w', type: 'smoothstep' },
  { id: 'e_ww_ao', source: 'wieslawa_w', target: 'andrzej_o', type: 'step', style: { strokeDasharray: '5,5' } },
  
  { id: 'e_as_js', source: 'aleksander_s', target: 'janina_s', type: 'smoothstep' },
  { id: 'e_as_jes', source: 'aleksander_s', target: 'jerzy_s', type: 'smoothstep' },
  { id: 'e_as_zs', source: 'aleksander_s', target: 'zofia_s', type: 'smoothstep' },
  
  { id: 'e_js_ja', source: 'janina_s', target: 'jan_a', type: 'step', style: { strokeDasharray: '5,5' } },
  { id: 'e_jes_kd', source: 'jerzy_s', target: 'krystyna_d', type: 'step', style: { strokeDasharray: '5,5' } },
  { id: 'e_jes_dj', source: 'jerzy_s', target: 'dzieci_jerzego', type: 'smoothstep' },
  
  { id: 'e_zs_h', source: 'zofia_s', target: 'hania', type: 'smoothstep' },
  { id: 'e_h_g', source: 'hania', target: 'gosia', type: 'smoothstep' },
  { id: 'e_g_p', source: 'gosia', target: 'pawel', type: 'step', style: { strokeDasharray: '5,5' }, animated: true },
  { id: 'e_g_t', source: 'gosia', target: 'tosia', type: 'smoothstep' },
  { id: 'e_p_t', source: 'pawel', target: 'tosia', type: 'smoothstep' },
  
  { id: 'e_ks_bs', source: 'kazimierz_s', target: 'barbara_s', type: 'smoothstep' },
  { id: 'e_bs_ku', source: 'barbara_s', target: 'kazimierz_u', type: 'step', style: { strokeDasharray: '5,5' } },
  { id: 'e_bs_au', source: 'barbara_s', target: 'anna_u', type: 'smoothstep' },
  { id: 'e_bs_pu', source: 'barbara_s', target: 'pawel_u', type: 'smoothstep' },
  
  // Franciszek i Leon
  { id: 'e_w_of', source: 'walenty', target: 'ojciec_fl', type: 'smoothstep' },
  { id: 'e_a_of', source: 'agnieszka', target: 'ojciec_fl', type: 'smoothstep' },
  { id: 'e_of_f', source: 'ojciec_fl', target: 'franciszek', type: 'smoothstep' },
  { id: 'e_of_l', source: 'ojciec_fl', target: 'leon', type: 'smoothstep' },
  
  { id: 'e_f_z1', source: 'franciszek', target: 'f_zona_1', type: 'step', style: { strokeDasharray: '5,5' } },
  { id: 'e_f_z2', source: 'franciszek', target: 'f_zona_2', type: 'step', style: { strokeDasharray: '5,5' } },
  { id: 'e_f_z3', source: 'franciszek', target: 'f_zona_3', type: 'step', style: { strokeDasharray: '5,5' } },
  
  { id: 'e_z2_m', source: 'f_zona_2', target: 'marian', type: 'smoothstep' },
  { id: 'e_z2_h', source: 'f_zona_2', target: 'henryk', type: 'smoothstep' },
  { id: 'e_z2_k', source: 'f_zona_2', target: 'kazik', type: 'smoothstep' },
  { id: 'e_z2_b', source: 'f_zona_2', target: 'bolek', type: 'smoothstep' },
  { id: 'e_z3_w', source: 'f_zona_3', target: 'wiesia_f', type: 'smoothstep' },
  { id: 'e_w_t', source: 'wiesia_f', target: 'tomek', type: 'step', style: { strokeDasharray: '5,5' } },
  
  { id: 'e_l_j', source: 'leon', target: 'jasiek', type: 'smoothstep' },
  { id: 'e_j_c1', source: 'jasiek', target: 'corka_j_1', type: 'smoothstep' },
  { id: 'e_j_c2', source: 'jasiek', target: 'corka_j_2', type: 'smoothstep' },
  { id: 'e_j_a', source: 'jasiek', target: 'andrzej_j', type: 'smoothstep' },
  
  { id: 'e_c1_r', source: 'corka_j_1', target: 'rafal', type: 'smoothstep' },
  { id: 'e_c2_m', source: 'corka_j_2', target: 'marzena', type: 'smoothstep' },
  { id: 'e_a_t', source: 'andrzej_j', target: 'teresa', type: 'step', style: { strokeDasharray: '5,5' } },
  
  // Paweł parents connect
  { id: 'e_f_rp', source: 'franciszek', target: 'rodzic_pawla', type: 'smoothstep' },
  { id: 'e_rp_p', source: 'rodzic_pawla', target: 'pawel', type: 'smoothstep' },
];
